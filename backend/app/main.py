...
from app.api.routes import health, auth, accounts, payees, transactions, translator
...
for router in [health.router, auth.router, accounts.router, payees.router, transactions.router, translator.router]:
